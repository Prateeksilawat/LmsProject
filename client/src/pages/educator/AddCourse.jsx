...
const AddCourse = () => {
  ...
  // Add lecture to the selected chapter
  const addLecture = () => {
    setChapters(
      chapters.map((chapter) => {
  ...
  useEffect(() => {
    ...
    if (!quillRef.current && editorRef.current) {
      ...
      // Save editor content to state on change
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4 max-w-md w-full text-gray-500">
        ...
        <div className="flex items-center justify-between flex-wrap">
          ...
          <div className="flex md:flex-row flex-col items-center gap-3">
            ...
            <label htmlFor="thumbnailImage" className="flex cursor-pointer items-center gap-3">
              <img src={assets.file_upload_icon} alt="fileUpload" className="p-3 bg-blue-500 rounded" />
              <input
                type="file"
                id="thumbnailImage"
                ...
                <div className="flex items-center">
                  ...
                  >
                    <img
                      ...
                      alt="icon"
                      className={`transition-all ${chapter.collapsed && "-rotate-90"}`}
                      width={14}
                    />
                  </button>
