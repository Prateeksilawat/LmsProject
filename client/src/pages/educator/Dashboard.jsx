    ...
    md:p-8 md:pb-0 p-4 pt-8 pb-0'>
         <div className='space-y-5'>
             ...
             <div className='flex flex-wrap gap-5 items-center'>
              ...
              <div className='flex items-center gap-3  border border-blue-500
              p-4 w-56 rounded-md'>
              <img src={assets.patients_icon} alt='patientsIcon' />
              <div>
              ...
              <div className='flex items-center gap-3  border border-blue-500
              p-4 w-56 rounded-md'>
              <img src={assets.appointments_icon} alt='appointmentsIcon' />
              <div>
                <p className='text-2xl font-medium text-gray-600'>
              ...
              <div className='flex items-center gap-3  border border-blue-500
              p-4 w-56 rounded-md'>
              <img src={assets.earning_icon} alt='EarningIcon' />
              <div>
