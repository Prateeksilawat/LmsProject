              ...
              courseData.courseContent.map((chapter, index) => (
                <div key={index} className="border border-gray-300 bg-white mb-2 rounded">
                  ...
                  >
                    ...
                    <p>{chapter.chapterContent.length} lecture(s) - {calculateChapterTime(chapter)}</p>
                  </div>
                    ...
                    <ul className="list-disc md:pl-10 pl-4 pr-4 py-2 text-gray-600 border-t border-gray-300">
                      {chapter.chapterContent.map((lecture, i) => (
                        <li key={i} className="flex items-start gap-2 py-1">
                          <img
                            src={lecture.isWatched ? assets.blue_tick_icon : assets.play_icon}
                            alt="playicon"
          ...
          {playerData ? (
            <div>
              ...
              <div className="flex justify-between items-center mt-1">
                ...
                <button className="text-blue-600 cursor-pointer">{false ? 'Completed' : 'Mark Completed'}</button>
              </div>
            </div>
          ) : (
